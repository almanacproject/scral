...
import it.ismb.pertlab.smartcity.api.PlasticBin;

/**
 * @author <a href="mailto:dario.bonino@gmail.com">Dario Bonino</a>
 *
 */
public class PlasticWasteUei extends AbstractUei
{
	
	/**
	 * @param descriptor
	 */
	public PlasticWasteUei(UeiDescriptor descriptor)
	{
		super(descriptor);
	...
	{
		return PlasticBin.class.getSimpleName();
	}
