...
import it.ismb.pertlab.smartcity.api.OrganicBin;

/**
 * @author <a href="mailto:dario.bonino@gmail.com">Dario Bonino</a>
 *
 */
public class OrganicWasteUei extends AbstractUei
{
	
	/**
	 * @param descriptor
	 */
	public OrganicWasteUei(UeiDescriptor descriptor)
	{
		super(descriptor);
	...
	{
		return OrganicBin.class.getSimpleName();
	}
