...
public class FillLevelSensorFit extends BaseSerialDevice implements FillLevel
{
    ...
    private DecimalMeasure<?> level;
    private DecimalMeasure<Length>  depth;
    ...
    public void messageReceived(String payload)
    {
        ...
        try
        {
            ...
            this.depth = DecimalMeasure.valueOf(values.getDepth().trim()+" "+SI.CENTIMETER);
            this.level = DecimalMeasure.valueOf(values.getLevel().trim()+" "+javax.measure.unit.Unit.ONE);
    ...
    {
        return this.depth.intValue(SI.CENTIMETER);
    }

    @Override
    public Double getLevel()
    {
        return this.level.getValue().doubleValue();
    }
